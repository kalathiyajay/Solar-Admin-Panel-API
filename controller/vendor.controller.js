...
exports.createNewVendor = async (req, res) => {
    try {
        let { businessName, officeAddress, pincode, district, state, country, companyEmailId, contactPersonalDetails, contactPersonName, designation, department, contactNumber, emailId, registrationType, gstNumber, panNumber, UdyamRegistration, government, supplier, transportar, bankName, bankDetails, branchName, accountNumber, accountType, IFSCCode } = req.body;
...
exports.getvendorById = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Vendor Found SuccessFully", vendor: vendorFindById })
...
exports.removeVendor = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Vendor Deleted SuccessFully" })
