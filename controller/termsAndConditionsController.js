...
exports.getAllConditions = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, totalTermsAndConditions: count, message: "All Terms And Conditions Found SuccessFully..", termsAndConditions: paginatedAllConditions });
